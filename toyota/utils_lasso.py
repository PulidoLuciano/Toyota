...
class SklearnLassoDiagnostic:
    """
    Diagnostic plots to identify potential problems in a scikit-learn Lasso regression fit.
    Accepts a fitted Lasso model, X (features), and y (target).
    """
    ...
    def __init__(
        ...
        if not hasattr(model, "coef_"):
            raise ValueError("Model must be a fitted sklearn Lasso instance.")
